...
source('Code_datOpen_timings_glmmTMB.R')

Timings <- rbind(m0,m1,m2,m3,m4,m5,m6,m7,m8,m9,m10,m11,m12,m13,m14,m15)
colnames(Timings) <- c(colnames(Timings)[1:5],"FixedEf","RandomEf","AIC","BIC","logLik")
Timings

# write to new file
write.csv(Timings, file = "DataTimings/datOpen_timings_glmmTMB.csv",row.names=FALSE, na="")
...
# inserted #bedst glmmTMB model in forward selection for datOpen data set and save timings
source('Code_datOpen_timings_glmer_nAGQ1.R')
...
# write to new file
write.csv(Timings, file = "DataTimings/datOpen_timings_glmer_nAGQ1.csv",row.names=FALSE, na="")
...
# inserted #bedst glmmTMB model in forward selection for datOpen data set and save timings
source('Code_datOpen_timings_glmer_nAGQ0.R')
...
# write to new file
write.csv(Timings, file = "DataTimings/datOpen_timings_glmer_nAGQ0.csv",row.names=FALSE, na="")
